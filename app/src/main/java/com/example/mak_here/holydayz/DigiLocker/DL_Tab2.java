 ...
 */
public class DL_Tab2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_dl__tab2, container, false);
    ...
    public void onClick(View v) {
        ...
        i.setData(Uri.parse("http://digilocker.gov.in/"));
