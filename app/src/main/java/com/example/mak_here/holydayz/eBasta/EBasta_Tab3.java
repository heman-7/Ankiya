 ...
 */
public class EBasta_Tab3 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ebasta__tab3, container, false);
    ...
    public void onClick(View v)
    {
        ...
        i.setData(Uri.parse("http://www.networkedindia.com/2015/06/03/e-basta-a-digital-india-initiative-for-students-to-download-study-material/"));
