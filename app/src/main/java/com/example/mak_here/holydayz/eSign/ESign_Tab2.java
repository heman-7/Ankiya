 ...
 */
public class ESign_Tab2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_esign__tab2, container, false);
    ...
    public void onClick(View v) {
        ...
        i.setData(Uri.parse("http://www.digilocker.gov.in/"));
