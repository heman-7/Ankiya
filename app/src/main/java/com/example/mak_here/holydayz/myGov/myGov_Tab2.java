 ...
 */
public class myGov_Tab2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_mygov_tab2, container, false);
    ...
    public void onClick(View v) {
        ...
        i.setData(Uri.parse("http://www.mygov.in/"));
        Intent chooser = i.createChooser(i, "Open This Site Through");
